...
In December 2025, I joined [Wipro](https://www.wipro.com/) as a Senior Software Engineer. I got an interview directly with client that is IBM. The whole process lasted for a month and has 5-6 rounds of interviews. Currently working on the IBM project, it is called Watson Orchestrate. It is an IBM cloud product, working here is let's say not as good as working in vidgyor. Mostly because of the bureaucracy, there are too many processes, and little coding. My goal is to learn these processes, so hopefully this would make me ready for the future AI apocalypse.